...
<input type="hidden" value="${sessionss}" id="session">
   ...
   <div style = "font-size:35px">
      <span style = "color:#fd8731; font-weight: bold">'${KEYWORD}'&nbsp;</span><span>의 검색 결과</span>
      </div>
      <div class="row gy-5">
         <div class="container">
            <div class="row gy-5">
               <div class="col">
                  <div style="float: left; font-size: 17.5px; margin-top: 10px; padding-left: 11px;">
                     총&nbsp;<strong style ="color:#fd8731"><c:out value="${count}" /></strong>&nbsp;개의 결과
                  </div>
        ...
        <c:if test="${count1.MO_COUNT gt 4}">
            ...
            <c:forEach begin="0" end="3" items="${list1}" var="m" varStatus="var">
               ...
               <c:if test="${count1.MO_COUNT eq 0}">
                  <div class="row gy-5">
                   <div class="none" style = "margin-bottom:76px; font-size:17px;">모임이 존재하지 않습니다.</div>
                  </div>
               </c:if>
         </div>
         <hr>
