			...
			<div class="container">
				<div style="font-size: 14.5px; margin-bottom: 0px">
					<div style="font-size: 35px">
						<span style="color: #fd8731; font-weight: bold">'${KEYWORD}'&nbsp;</span><span>의
							검색 결과</span>
					</div>
					<div class="row gy-5">
						<div class="container">
